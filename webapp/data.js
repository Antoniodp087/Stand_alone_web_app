module.exports = function() {
    return {
        products: [
            ...
            { id: 3, name: "Soccer Ball", category: "Soccer", description: "FIFA-approved size and weight", price: 19.95 },
            { id: 4, name: "Corner Flags", category: "Soccer", description: "Give your playing field a professional touch", price: 34.95 },
            { id: 5, name: "Stadium", category: "Watersports", description: "35,000 seat stadium", price: 79500 },
            { id: 6, name: "Thinking Cap", category: "Chess", description: "improve brain efficiency by 75%", price: 16 },
            { id: 7, name: "Unsteady Chair", category: "Chess", description: "Secretly give youy opponent a disadvantage", price: 29.95 },
            { id: 8, name: "Human Cheass Board", category: "Chess", description: "A fun game for the family ", price: 75 },
